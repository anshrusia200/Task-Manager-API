...
userSchema.methods.toJSON = function () {             // toJSON is helping in remove all tokens and password from the user object
    const user = this
...
userSchema.statics.findByCredentials = async (email, password) => {       // static methods are accessible on the models also known as the model methods
...
userSchema.pre('save', async function (next) {     // we are not using arrow functions because this keyword will not be allowed
