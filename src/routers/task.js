...
router.get('/tasks', auth , async (req,res) => {
    ...
    if (req.query.completed){           //remember that req.query.completed will give a string and not a boolean but we want a boolean
...
router.patch('/tasks/:id', auth ,async (req,res) => {
    ...
    if(!isValidOperation) {res.status(400).send({error : 'Invalid operation'})}
